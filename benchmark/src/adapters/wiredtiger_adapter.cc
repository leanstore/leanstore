...
void WiredTigerDB::CommitTransaction() { session->commit_transaction(session, nullptr); }
...
template <class RecordBase>
void WiredTigerAdapter<RecordBase>::UpdateInPlace(const typename RecordBase::Key &r_key,
