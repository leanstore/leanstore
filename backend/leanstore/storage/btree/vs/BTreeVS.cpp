...
// -------------------------------------------------------------------------------------
void BTree::iterateChildSwips(void */*btree_object*/, struct BufferFrame &bf, std::function<bool(Swip<BufferFrame> &)> callback)
{
   ...
   for ( u16 i = 0; i < c_node.count; i++ ) {
      // TODO: protect against segfault when reading beyond page bc. offset
