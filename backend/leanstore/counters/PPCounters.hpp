...
struct PPCounters {
  ...
  s64 phase_1_ms = 0, phase_2_ms = 0, phase_3_ms = 0, poll_ms = 0;
  // Phase 3 detailed
  u64 async_wb_ms = 0, submit_ms = 0;
  u64 phase_1_counter = 0, phase_2_counter = 0, phase_3_counter = 0;
  // -------------------------------------------------------------------------------------
  u64 evicted_pages = 0, pp_thread_rounds = 0;
  // -------------------------------------------------------------------------------------
  u64 flushed_pages_counter = 0;
  u64 unswizzled_pages_counter = 0;
  // -------------------------------------------------------------------------------------
