...
// @param locality: a value between 0 and 100, indicating how many tuples should be on the same page: 0 -> uniform distribution and 100 -> all tuples on the same page
