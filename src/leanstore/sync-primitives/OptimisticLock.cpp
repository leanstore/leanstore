...
ReadGuard::ReadGuard(atomic<u64> *version_ptr, u64 local_version, bool locked)
        ...
        , locked(locked) {}
// -------------------------------------------------------------------------------------
ExclusiveGuard::ExclusiveGuard(leanstore::ReadGuard &read_lock) : ref_guard(read_lock){
...
// -------------------------------------------------------------------------------------
// TODO: part
SharedGuard::SharedGuard(leanstore::ReadGuard &read_guard) : ref_guard(read_guard) {
